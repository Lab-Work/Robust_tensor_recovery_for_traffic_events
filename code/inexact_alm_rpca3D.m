function [X_hat, E_hat, iter] = inexact_alm_rpca3D(D, lambda, tol, maxIter)
% Jun 2019
% This matlabcode implements the robust tensor PCA with element-sparse
% gross corruption.
% 
% [X_hat, E_hat, iter] = inexact_alm_rpca21_v4(D, lambda, tol, maxIter)
% returns the estimated low rank tensor X_hat, element-sparse
